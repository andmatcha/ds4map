...
| `30` | 1 | `u8` | `control_byte` | nyokki / initialize / home pose |
...
Manual モードでは、AC v6 の主要フィールドは 2 本の CAN フレームへ分かれる。

### CAN ID `0x200`

| CAN byte | 元の AC v6 フィールド |
| ---: | --- |
| `0` | `current[0]` LSB |
| `1` | `current[0]` MSB |
| `2` | `current[1]` LSB |
...
| `triangle / cross` | `current[4]` | `0x201 Data[0..1]` |
| `circle / square` | `current[5]` | `0x201 Data[2..3]` |
| `D-pad Right / Left` | `current[6]` | `0x201 Data[4..5]` |
| D-pad Up | `control_byte.bit3` | `0x201 Data[6]` |
| D-pad Down | `control_byte.bit4` | `0x201 Data[6]` |
| `r3` | `control_byte.bit5` | `0x201 Data[6]` |
| `l3` | `control_byte.bit6` | `0x201 Data[6]` |
